# Portfolios - Akhdan Fadhilillah Ps
...
- **Interactivity**: Vanilla JavaScript (Animations, reveal effects, and dynamic UI)
...
- **Achievements & Certificates**: Interactive carousel showcasing my professional certifications.
...
├── website-portfolio/ # Media assets (images, certificates, project thumbnails)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/dnhmyy/portfolios-akhdnn.git
   ```
...
- **Email**: [akhdansutiar@gmail.com](mailto:akhdansutiar@gmail.com)
- **LinkedIn**: [Akhdan Fadhilillah](https://www.linkedin.com/in/akhdan-fadhilillah/)
- **GitHub**: [@dnhmyy](https://github.com/dnhmyy)

---
&copy; 2024 - 2026 Akhdan Fadhilillah Ps.
